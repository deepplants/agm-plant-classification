...
class MLP(nn.Module):
    def __init__(self, dim, dim_out, num_layers, hidden_size = 256, sigmoid_activation = False):
        super().__init__()
        ...
        self.net = nn.Sequential(
            *layers,
            ...
            nn.Sigmoid() if sigmoid_activation else nn.Identity()
        )
